# Ablation: Replace multi-scale dilation branches (d=1,2,5) with single branch dilation=1 only
import torch
...
class ULiteModel_NoUAFM_NoDG_NoMultiScale(nn.Module):
...
def build_model(num_classes=1):
    return ULiteModel_NoUAFM_NoDG_NoMultiScale(num_classes=num_classes)

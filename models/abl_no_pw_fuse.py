...
class Axial_PFCU_NoPWFuse(nn.Module):
...
class EncoderBlock(nn.Module):
    def __init__(self, in_c, out_c, mixer_kernel=(5, 5)):
        ...
        self.pfcu      = Axial_PFCU_NoPWFuse(in_c, mixer_kernel=mixer_kernel)
...
class AblModel_NoPWFuse(nn.Module):
...
def build_model(num_classes=1):
    return AblModel_NoPWFuse(num_classes=num_classes)

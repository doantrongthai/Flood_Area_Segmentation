# Ablation A9: Gated spatial attention in TinyUAFM replaced with simple element-wise addition — isolates contribution of alpha-gated cross-feature selection

...
class DecoderBlock_Concat(nn.Module):
    def __init__(self, in_c, out_c, mixer_kernel=(5, 5)):
        super().__init__()
    ...
    def forward(self, x, skip):
        ...
        x = self.act(self.bn(self.fuse(torch.cat([x, skip], dim=1))))
        return x


class AblModel_ConcatDecoder(nn.Module):
    def __init__(self, num_classes=1):
        ...
        self.d4 = DecoderBlock_Concat(256, 128, mixer_kernel=mk)
        self.d3 = DecoderBlock_Concat(128, 64,  mixer_kernel=mk)
        self.d2 = DecoderBlock_Concat(64,  32,  mixer_kernel=mk)
        self.d1 = DecoderBlock_Concat(32,  16,  mixer_kernel=mk)
...
def build_model(num_classes=1):
    return AblModel_ConcatDecoder(num_classes=num_classes)

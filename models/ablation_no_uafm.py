# Ablation A3: TinyUAFM replaced with naive concatenation + pointwise conv — isolates contribution of gated attention fusion in decoder
...
class DecoderBlock(nn.Module):
    def __init__(self, in_c, out_c, mixer_kernel=(5, 5)):
        ...
        self.fusion  = NaiveFusion(in_c=in_c, skip_c=out_c, out_c=out_c)

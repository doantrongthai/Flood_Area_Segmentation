# Ablation: Remove decoder bottleneck refinement (pw_down/pfcu/pw_up), keep only upsample + add + BN+act
import torch
...
class ULiteModel_NoUAFM_NoDG_NoDecoderRef(nn.Module):
...
def build_model(num_classes=1):
    return ULiteModel_NoUAFM_NoDG_NoDecoderRef(num_classes=num_classes)

...
class DecoderBlock_NearestUp(nn.Module):
    def __init__(self, in_c, out_c, mixer_kernel=(5, 5)):
        super().__init__()
...
class AblModel_NearestUp(nn.Module):
    def __init__(self, num_classes=1):
        ...
        self.d4 = DecoderBlock_NearestUp(256, 128, mixer_kernel=mk)
        self.d3 = DecoderBlock_NearestUp(128, 64,  mixer_kernel=mk)
        self.d2 = DecoderBlock_NearestUp(64,  32,  mixer_kernel=mk)
        self.d1 = DecoderBlock_NearestUp(32,  16,  mixer_kernel=mk)
...
def build_model(num_classes=1):
    return AblModel_NearestUp(num_classes=num_classes)

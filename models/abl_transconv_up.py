...
class DecoderBlock_TransConv(nn.Module):
    def __init__(self, in_c, out_c, mixer_kernel=(5, 5)):
        super().__init__()
        self.up        = nn.ConvTranspose2d(in_c, out_c, kernel_size=2, stride=2, bias=False)
...
class AblModel_TransConvUp(nn.Module):
    def __init__(self, num_classes=1):
        ...
        self.d4 = DecoderBlock_TransConv(256, 128, mixer_kernel=mk)
        self.d3 = DecoderBlock_TransConv(128, 64,  mixer_kernel=mk)
        self.d2 = DecoderBlock_TransConv(64,  32,  mixer_kernel=mk)
        self.d1 = DecoderBlock_TransConv(32,  16,  mixer_kernel=mk)
...
def build_model(num_classes=1):
    return AblModel_TransConvUp(num_classes=num_classes)

...
class AblModel_DeeperBottleneck(nn.Module):
    def __init__(self, num_classes=1):
        ...
        self.b4a = SimpleBottleNeck(256, max_dim=128)
        self.b4b = SimpleBottleNeck(256, max_dim=128)
...
def build_model(num_classes=1):
    return AblModel_DeeperBottleneck(num_classes=num_classes)

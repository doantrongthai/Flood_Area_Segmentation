...
class EncoderBlock(nn.Module):
    def __init__(self, in_c, out_c, mixer_kernel=(5, 5)):
        ...
        self.pfcu      = DualBranchSRP(in_c, mixer_kernel=mixer_kernel)
...
class AblModel_DualBranch(nn.Module):
...
def build_model(num_classes=1):
    return AblModel_DualBranch(num_classes=num_classes)

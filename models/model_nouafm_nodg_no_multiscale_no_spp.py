# Ablation: Combined removal of multi-scale dilation branches and SPP bottleneck, keep only single dilation=1 branch and simple DW bottleneck
import torch
...
class ULiteModel_NoUAFM_NoDG_NoMultiScale_NoSPP(nn.Module):
...
def build_model(num_classes=1):
    return ULiteModel_NoUAFM_NoDG_NoMultiScale_NoSPP(num_classes=num_classes)

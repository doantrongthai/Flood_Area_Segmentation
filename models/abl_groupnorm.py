...
def make_gn(dim, num_groups=8):
    g = min(num_groups, dim)
...
class AblModel_GroupNorm(nn.Module):
...
def build_model(num_classes=1):
    return AblModel_GroupNorm(num_classes=num_classes)
